...
class MCOnPolicy(basic.WithoutModel):
    def __init__(self, obstacle_reward=-100, final_reward=500, loop_time=100000, epsilon=0.5, gamma=0.9):
        super(MCOnPolicy, self).__init__(obstacle_reward, final_reward, loop_time, epsilon)
...
if __name__ == "__main__":
    agent = MCOnPolicy(-100, 1000, 10000, 0.5, 0.9)
    agent.loop()
